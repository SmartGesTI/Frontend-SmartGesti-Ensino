...
interface HelpButtonProps {
  ...
  /** Lado do offcanvas */
  side?: 'left' | 'right'
  /** Se true, o sheet começa abaixo do navbar */
  belowNavbar?: boolean
}
...
export function HelpButton({
  ...
  return (
    <Sheet onOpenChange={(open) => !open && setHighlightedElement(null)}>
      ...
      <SheetContent side={side} belowNavbar={belowNavbar} className="flex flex-col p-0 overflow-hidden">
        {/* Header Fixo */}
